...
a)  ping
    ...
    ::: {.solution}
    Damit kann auch der Ebene der IP-Protokolls geprüft werden, ob ein
    anderes System erreichbar ist.
    :::
...
b)  nslookup
    ...
    ::: {.solution}
    Damit können über das DNS-System Namen aufgelöst werden oder andere
    RRs abgefragt werden.
    :::
...
c)  tracert/traceroute
    ...
    ::: {.solution}
    Damit kann der Weg der IP-Pakete durch ein Netzwerk nachverfolgt
    werden.
    :::
...
b)  Was ist der Grundansatz von SDN hinsichtlich der Geräte und der
    ...
    ::: {.solution}
    Die Kontrolllogik wird von der ausführenden Geräten entkoppelt, um
...
c)  Aus welchen Schichten besteht die Netzwerkvirtualisierung?
    ...
    - control layer (Steuerungsschicht)

    - infrastructure layer (Infrastukturschicht)
    :::
...
d)  Welche Netzwerkfunktionen werden in der Anwendungsschicht
    ...
    ::: {.solution}
    - application wide area networks (WAN),
    - firewalls,
    - load balancing,
    - WAN Optimization Controllers (WOCs),
    - Authentication and Application Delivery Controllers (ADCs).
    :::
...
e)  Was leistet die Steuerungsschicht?
    ...
    ::: {.solution}
    - policies and traffic flow across the network
    :::
...
g)  Was ist der Unterschied zwischen der Northbound-API und der
    ...
    ::: {.solution}
    Die Northbound-API dient der Kommunikation zwischen der
    Steuerungsschicht und der Anwendungsschicht.

    Die Southbound-API dient der Kommunikation zwischen der
    Steuerungsschicht und der Infrastukturschicht.
    :::
